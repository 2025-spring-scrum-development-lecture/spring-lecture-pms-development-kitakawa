...
class stayplan_page(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.all_plans = [
            "1【【１泊２食のお子様3000円！】【2025年春休み】家族旅行応援！お子様歓迎♪早いもの勝ち！春休み限定プラン",
            "2【イースター復活祭】×【女子旅】お部屋にはチョコレートたまご型お菓子などたくさん♪まったりしてねプラン(*´ω｀)",
            "3【2025ゴールデンウィーク★プレミアムプラン】前沢牛の豪華会席GWバージョンで特別なひと時を♪夜のイベントも大満足！",
        ...
        self.option_keywords = {
            ...
            "ご夕食はスタンダード": ["スタンダード","北投石"],
            "記念日・お祝い": ["記念日", "お誕生","イースター","ビール"],
